...
const Socials = () => {
  ...
  return (
    <div className='absolute hidden md:flex right-4 flex-col gap-8 top-24 z-10 text-primary text-2xl before:block before:bg-primary before:h-24 before:w-[2px] before:mx-auto after:block after:bg-primary after:h-24 after:w-[2px] after:mx-auto  '>
